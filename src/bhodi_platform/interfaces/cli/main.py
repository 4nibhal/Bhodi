...
def _health_command() -> int:
    """Probe the live bhodi-api /health endpoint and propagate its state.
    ...
    re-instantiates adapters. It uses BHODI_API_HOST and
    BHODI_API_PORT (the same env vars the API server reads) to
