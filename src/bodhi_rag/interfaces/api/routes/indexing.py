...
def _validate_api_source(
    ...
    if policy.root is None:
        raise ValueError(
            "Local file indexing via API is disabled until BODHI_API_SOURCE_ROOT is configured"
        )
    ...
    try:
        ...
        raise ValueError("Document source must stay within BODHI_API_SOURCE_ROOT") from exc
