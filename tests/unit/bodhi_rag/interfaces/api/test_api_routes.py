...
@pytest.fixture
def client_factory(mock_bodhi_rag_app, monkeypatch):
    """Create TestClient instances with configurable API source roots."""

    @contextmanager
    def _factory(source_root: Path | None):
        from bodhi_rag.interfaces.api import app as app_module
        ...
        with patch("bodhi_rag.interfaces.api.app.Container") as MockContainer:
...
class TestDocumentsEndpoint:
    ...
    def test_index_document_resolves_source_within_root(self, client, mock_bodhi_rag_app, tmp_path):
    ...
    def test_index_document_internal_error_is_sanitized(self, client, mock_bodhi_rag_app):
    ...
    def test_delete_document_not_found_returns_404(self, client, mock_bodhi_rag_app):
...
class TestConversationsEndpoint:
    ...
    def test_get_conversation_returns_200(self, client, mock_bodhi_rag_app):
...
class TestQueryRouteErrors:
    ...
    def test_query_internal_error_is_sanitized(self, client, mock_bodhi_rag_app):
