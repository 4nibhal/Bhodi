...
class TestHealthEndpoint:
    ...
    def test_health_returns_200_with_services(self, client, mock_bodhi_rag_app):
    ...
    def test_health_degraded_returns_503(self, client, mock_bodhi_rag_app):
